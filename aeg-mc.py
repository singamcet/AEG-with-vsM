...
'''
sourceFileName = raw_input("Enter 1st file name:") 

sourceFile = open(sourceFileName, "r")
print "Enter the name(path) of file containing the Essay to be graded :: "
sampFileName = raw_input("Enter 2st file name:") 
score=coh(sourceFileName,sampFileName)
print
print
...
#Coherence
coherenceScore = score*5 #getCoherenceMeasure(essay)
...
<body>
	<div id = "canvas">
	<div>
		<div id = "heading"> <h1><center> AUTOMATED ESSAY SCORE </center></h1></div>
		<br />'''
...
s = s + '''</div></div> <br /> <hr /> <hr /> <br />
		<div id="conclusion">
			Vishnug0paL <br /> Guide: Jisha Babu
		</div>
...
print "\n\nThank You for using our Automated Essay Scoring\n"
